...
(function (CSSLoaderPlugin) {
     ...
     */
    let BrowserCSSLoader = /** @class */ (function () {
        ...
        BrowserCSSLoader.prototype._insertLinkNode = function (linkNode) {
            ...
            let other = head.getElementsByTagName('link') || head.getElementsByTagName('script')
            if (other.length > 0) {
        ...
        BrowserCSSLoader.prototype.createLinkTag = function (name, cssUrl, externalCallback, externalErrorback) {
            ...
            let callback = function () { return _this._onLoad(name, externalCallback) }
            let errorback = function (err) { return _this._onLoadError(name, externalErrorback, err) }
        ...
        BrowserCSSLoader.prototype._linkTagExists = function (name, cssUrl) {
            let i, len, nameAttr, hrefAttr, links = document.getElementsByTagName('link')
